...
#   4. Optional Notion validation if NOTION_TOKEN + NOTION_LEADS_DATABASE_ID
#      are present (legacy lead-form integration).
#
...
# ---------- 3. Optional Notion reachable + database shared ------------------
if [[ -f "$AGENT_ENV" ]]; then
